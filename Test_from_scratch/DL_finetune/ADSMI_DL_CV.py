...
class MyDataset_finetune(Dataset):
    ...
    def __init__(self,train_df, train_indices=None, test_indices=None, train=True, sample_rate=32000, desired_length_in_seconds=10):
...
def create_generators_finetune(train_df,train_indices=None, test_indices=None):
    train_dataset = MyDataset_finetune(train_df=train_df, sample_rate=config.goal_sr_labeled, train_indices=train_indices, train=True, desired_length_in_seconds=config.desired_length_in_seconds)
    test_dataset = MyDataset_finetune(train_df=train_df, sample_rate=config.goal_sr_labeled,test_indices=test_indices, train=False, desired_length_in_seconds=config.desired_length_in_seconds)
...
def create_generators_finetune_val(val_df):
    val_dataset = MyDataset_finetune_val(val_df=val_df, sample_rate=config.goal_sr_labeled,desired_length_in_seconds=config.desired_length_in_seconds)
