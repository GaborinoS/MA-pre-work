...
class MyDataset_pretrain(Dataset):
    ...
    def __init__(self, data_names, path ,train=True, desired_length_in_seconds=10):
        ...
        self.pipeline = MyPipelinePreTrain_2(input_sample_rate=config.goal_sr_labeled, device="cuda", desired_length_in_seconds=desired_length_in_seconds, train=self.train)
    ...
    def __getitem__(self, index):
        ...
        mel_spec_aug1, mel_spec_aug2 = self.pipeline(sample_rate_new_pos,waveform_pos,goal_r=self.sample_rate)
